...
//!
//! Used by Hive's OAuth-based sign-in flows (e.g. MCP servers, ChatGPT
...
/// layout styled to match Hive's dark theme. The `title` is rendered as a
                    ...
                    Err(err) => {
                        ...
                        (
                            ...
                            oauth_callback_page(
                                ...
                                "Something went wrong. Please try again from Hive.",
                                true,
                            ),
                        )
                    }
